...
public class AmbisafeNode {
    ...
    public static BigInteger getBalance(String address, String symbol) {
        byte[] encodedData = BALANCE_OF.encode(check0x(address), symbol.toUpperCase());
        String data = "0x" + Hex.toHexString(encodedData);

        Map<String, Object> params = new HashMap<>();
        params.put("to", CONTRACT_ADDRESS);
    ...
    public static String transfer(String rawHex) {
//        Map<String, Object> params = new HashMap<>();
//        params.put("to", )
        return null;
    }
    ...
    private static Map<String, Object> prepareRpcCall(String method, Object params) {
        ...
        map.put("params", new Object[] {params});
        map.put("id", 1);
    ...
    public static void main(String[] args) {
        System.out.println("getTransactionsCount: " + getTransactionsCount("a085e2f5b4d6e8e611853ad585a1b6c444116ce2"));
        System.out.println("getBalance: " + getBalance("a085e2f5b4d6e8e611853ad585a1b6c444116ce2", "OD"));
    }
}
